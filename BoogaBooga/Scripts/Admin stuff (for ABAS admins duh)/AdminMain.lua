...
if Data.DeveloperMode then title = title .. " (Dev)" end
...
lib.AddButton("Kick All ABAS Users", function()
	bank.CreateNotification("Kicked all ABAS users", colors.badRed)
	game.Players:Chat("AB_rZLIn_8")
end, Data.DeveloperMode)
